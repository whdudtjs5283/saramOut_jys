...
<h1 align="center"> 네이버 회원으로 가입</h1>

<div align="center"> 네이버 회원일 경우 고유번호가 부여됩니다.</div>
...
<td><input type="hidden" name="email" id="email" value="${email}" required>
${email} (네이버이메일이 자동 입력됩니다)</td></tr>
