	...
	function checkId(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data > 0){
					alert("사용 불가능한 아이디입니다. 다른아이디를 입력해주세요");
					$("#username").focus();
				}else{
					alert("사용가능한 아이디입니다");
					$("#userid").select();
...
<h1 align="center"> 카카오 회원으로 가입</h1>

<div align="center">카카오톡 회원일 경우 고유번호가 부여됩니다.</div>

<br>



<form action="minsert.do" method="post" id="form" name="form"
...
<tr height="20"><th width="150" >*고유번호</th>
<td><input type="hidden" name="userid" id="userid" value="${id_Num}" required>
${id_Num}
 
<button onclick="return checkId();">아이디 중복 확인</button></td></tr>
...
<tr height="20"><th >*성별</th>
<td>

<div class="checks"> <input type="checkbox" id="ex_chk" name="gender" value="m"> <label for="ex_chk">남자</label> </div> 
<div class="checks"> <input type="checkbox" id="ex_chk2" name="gender" value="f"> <label for="ex_chk2">여자</label> </div>
...
<tr height="20" width="150"><th> 주소 입력</th>
...
<input type="button" onClick="goPopup();" value="주소검색"/></td></tr>
	...
	<tr><td>도로명주소 전체</td><td><input type="text"  style="width:500px;" id="roadFullAddr"  name="fulladdress" /></td></tr>
	<tr><td>도로명주소           </td><td><input type="text"  style="width:500px;" id="roadAddrPart1"  name="roadaddress1" /></td></tr>
	<tr><td>고객입력 상세주소    </td><td><input type="text"  style="width:500px;" id="addrDetail"  name="detailaddress" /></td></tr>
	<tr><td>참고주소             </td><td><input type="text"  style="width:500px;" id="roadAddrPart2"  name="roadaddress2" /></td></tr>
