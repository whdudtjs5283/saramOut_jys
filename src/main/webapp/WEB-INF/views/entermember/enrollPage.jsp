...
<h1 align="center"> 기업 회원 가입</h1>




<form action="minsert2.do" method="post" id="form" name="form"
...
<tr height="20"><th width="150" >*담당자 성함</th>
...
<tr height="20"><th >*법인/사업자 번호 입력</th>
<td>
...
<tr height="20"><th >기업명</th>
<td><input type="company" name="company" ></td></tr>

<tr height="20"><th >이메일</th>
<td><input type="bemail" name="bemail" ></td></tr>

<tr height="20"><th >담당자 전화번호</th>
<td><input type="userphone" name="userphone" ></td></tr>

<tr height="20"><th >회사 전화번호</th>
<td><input type="companyphone" name="companyphone" ></td></tr>
...
<input type="button" onClick="goPopup();" value="주소검색"/></td></tr>
	...
	<tr><td>도로명주소 전체(포멧)</td><td><input type="text"  style="width:500px;" id="roadFullAddr"  name="fulladdress" /></td></tr>
...
<input type="submit" value="기업회원으로 가입하기">
