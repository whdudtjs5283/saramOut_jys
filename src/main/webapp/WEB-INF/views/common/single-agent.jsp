				...
				<div class="col-md-9 mb40">
					<div class="row mb30">
						...
						<div class="col-sm-8 mb40">
							<h2 class="font300">John Doe</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								Nullam facilisis aliquam finibus. Nullam at ante et nulla
								vehicula euismod ut eget urna.</p>
							<p>
								<strong>Email:</strong> support@john.com
							</p>
							<p>
								<strong>Phone:</strong> 01-1334-3204
							</p>
							<p class="social-inline">
								<strong>Social:</strong> <a href="#"><i
