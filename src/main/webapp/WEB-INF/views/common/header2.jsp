				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="allEmploymentList2.do">채용공고 리스트 </a></li>
		...
		<!--  여기가 기업 메뉴다 -->
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="aa.do">기업리스트</a></li>
							<li><a href="eApplyList.do?bid=${ loginMember2.bid }">지원 현황</a></li>
							<li><a href="moveFindTalentList.do?page=1">인재찾기</a></li>
							<li><a href="companyProfile.do">기업 정보 등록</a></li>
							<li><a href="companyProfile2.do">기업 정보 수정</a></li>
							<li><a href="add-listing.do">공고등록</a></li>
							<li><a href="employmentDetail.do">공고 상세</a></li>
					...
					<c:if test="${!empty loginMember2 }">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false">${loginMember2.username }님 <span
								class="caret"></span></a>
							<ul class="dropdown-menu">


								<li><a href="about.do">지원 현황</a></li>
								<li><a href="about.do">등록한 공고 관리</a></li>
								<li><a href="moveMyResumeList.do?userid=${ loginMember2.bid }">이력서 목록</a></li>
								<li><a href="moveNewResume.do?userid=${ loginMember2.bid }">새 이력서 등록</a></li>
