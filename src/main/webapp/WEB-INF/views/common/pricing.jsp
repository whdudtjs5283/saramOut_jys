	...
	<div class="container mb30">
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3 text-center center-heading mb40">
				<h2>Best Plans. Cancel Anytime</h2>
				<p>
		...
		<div class="row">
			<div class="col-sm-4 mb40">
				<div class="price-card">
					<h4>Personal</h4>
					<h1>
						<sup>$</sup> 9.99 <sub>/M</sub>
					</h1>
					<div class="price-button text-center">
						<a href="#" class="btn btn-default btn-lg">Get Start</a>
					</div>
					<ul class="list-unstyled">
						<li>10 GB Storage</li>
						<li>Long Established Fact</li>
						<li>5 Email Accounts</li>
						<li>6 Months Full Support</li>
						<li>No Renew Charge</li>
					</ul>
					<div class="price-bottom">
						<a href="#" class="link-underline">View More Details</a>
					</div>
				</div>
			</div>
			<!--/col-->
			<div class="col-sm-4 mb40">
				<div class="price-card">
					<h4>Business</h4>
					<h1>
						<sup>$</sup> 29.99 <sub>/M</sub>
					</h1>
					<div class="price-button text-center">
						<a href="#" class="btn btn-primary btn-lg">Get Start</a>
					</div>
					<ul class="list-unstyled">
