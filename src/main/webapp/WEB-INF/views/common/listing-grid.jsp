...
<%-- <%@ page import="org.kh.saramout.companyinfo.model.vo.CompanyInfo ,java.util.ArrayList" %> --%> 
<%-- <%
   ArrayList <CompanyInfo> list = (ArrayList<CompanyInfo>)request.getAttribute("list");
