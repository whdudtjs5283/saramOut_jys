   ...
   <div class="container" >
      ...
      <div class="mb50">
         ...
         <div class="form-group">
            <input class="form-control" type="text" name="recruit_title" value="${employment.recruit_title }">
         </div>
      </div>
      ...
      <div class="mb40">
         ...
         <div class="row">
            <div class="col-sm-6">
               <h4>모집부문</h4>
               <div class="form-group">
                  <input class="form-control" type="text" placeholder="모집부문" name="work_field" value="${employment.work_field }">
               </div>
               <h4>고용형태</h4>
               <div class="form-group">
               ...
               <div class="form-group-icon mb15">
                  <i class="fa fa-dollar"></i> <input type="text"
                     name="salary" placeholder="급여" value="${employment.salary }">
               </div>
            ...
            <div class="col-sm-6">
               ...
               <h4>우대사항</h4>
               <div class="form-group">
                  <input class="form-control" type="text" placeholder="우대사항" name="prefer" value="${employment.prefer }">
               </div>
               <h4>복리후생</h4>
               <div class="form-group">
                  <input class="form-control" type="text" placeholder="복리후생" name="benefits" value="${employment.benefits }">
               </div>
               <h4>채용인원</h4>
               <div class="form-group">
         ...
         <div class="mb30">
            ...
            <div class="form-group">
               <input type="hidden" name="bid" value="user01">
            </div>
            ...
            <div class="form-group">
               <input type="hidden" name="recruit_num" value="33">
            </div>
      </div>
      ...
      <div class="mb30">
         ...
         <div class="text-right mb40">
            <input type="submit" class="btn btn-lg btn-primary" value="채용공고 수정">
         </div>
      </div>
