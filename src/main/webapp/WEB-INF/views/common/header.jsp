					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="allEmploymentList.do">채용공고 리스트 개인용</a></li>
							 <li><a href="moveMyMScrapeList.do?userid=${ loginMember.userid }">멤버스크랩리스트</a></li>
							 <li><a href="moveMemberApplyList.do?userid=${ loginMember.userid }">지원한 이력서 보기</a></li>
					...
					<c:if test="${!empty loginMember }">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="moveMyResumeList.do?userid=${ loginMember.userid }">마이페이지</a></li>
								<li><a href="moveNewResume.do?userid=${ loginMember.userid }">새 이력서 등록</a></li>
								<li><a href="movetest.do">테스트</a></li>
								<li><a href="movemy.do">마이페이지</a></li>
								<li><a href="moveimg.do">이미지</a></li>
								<li><a href="movegrid.do">그리드</a></li>
