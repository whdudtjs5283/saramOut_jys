			...
			<div class="col-md-9 mb30">
				<div class="post-row">
					<div class="post-thumb mb20">
						<a href="#"><img src="resources/images/b2.jpg" alt=""
						...
						<div class="post-header clearfix">
							...
							<div class="overflow-hidden">
								...
								<ul class="list-inline">
									...
									<li><a href="#"><i class="fa fa-calendar"></i> 24 July
											2017</a></li>
									<li><a href="#"><i class="fa fa-reply-all"></i> 45</a></li>
								</ul>
							</div>
						</div>
						<!--/header-->
				...
				<div class="post-row">
					<div class="post-thumb mb20">
						<a href="#"><img src="resources/images/b1.jpg" alt=""
							class="img-responsive"></a>
					</div>
					<!--/thumb-->
					<div class="post-content">
						<div class="post-header clearfix">
							<a href="#"><img width="80" src="resources/images/av4.jpg" alt=""
								class="img-responsive img-circle"></a>
							<div class="overflow-hidden">
								<h3>
									<a href="#">Standard Image Post</a>
				...
				<div class="post-row">
					<div class="post-thumb mb20">
						<a href="#"><img src="resources/images/b3.jpg" alt=""
							class="img-responsive"></a>
					</div>
					<!--/thumb-->
					<div class="post-content">
						<div class="post-header clearfix">
							<a href="#"><img width="80" src="resources/images/av3.jpg" alt=""
								class="img-responsive img-circle"></a>
							<div class="overflow-hidden">
								<h3>
									<a href="#">Standard Image Post</a>
				...
				<div class="post-row">
					...
					<div class="post-content">
						<div class="post-header clearfix">
							<a href="#"><img width="80" src="resources/images/av2.jpg" alt=""
								class="img-responsive img-circle"></a>
							<div class="overflow-hidden">
								<h3>
									<a href="#">Standard Image Post</a>
