...
<body>
	...
	<!--fullscreen image-->
	<div class="hero-form bg-parallax parallax-overlay"
			...
			<div class="row">
				<div class="col-md-6 col-sm-7">
					...
					<div class="hero-buttons">
						<a href="#" class="btn btn-lg btn-white">Learn More</a> <a
							href="#" class="btn btn-lg btn-danger">Browse Listing</a>
					</div>
				</div>
				<div class="col-md-4 col-md-offset-1 col-sm-5">
					<div class="hero-search-form">
						...
						<form>
							...
							<div class="form-hero-group mb15">
								<i class="fa fa-map-marker"></i> <select class="form-control"
									title="Location">
									<option>Paris</option>
							...
							<div class="form-hero-group mb15">
								<i class="fa fa-folder"></i> <select class="form-control"
									title="Category">
